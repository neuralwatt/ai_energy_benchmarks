...
def test_pytorch_backend_reasoning_params():
    ...
    # Setup mocks
    backend.tokenizer.return_value = {"input_ids": Mock(shape=(1, 10)), "attention_mask": Mock()}
...
def test_vllm_backend_reasoning_params():
    ...
    backend = VLLMBackend(endpoint="http://mock:8000/v1", model="mock-model")
...
def test_reasoning_disabled():
    ...
    gen_kwargs = {"max_tokens": 100, "temperature": 0.7}
